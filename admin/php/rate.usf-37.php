...
if(checkStates_37($shipment["o_state"],$shipment["d_state"]) && $FUEL_BACKOUT && $HTTP_HOST=="admin.trollcompany.com"){
	...
	if($classes && $weights){
		...
		if($fak_class_temp){
			...
			$usf_costs_temp = autoRateUSF_37($shipment["o_zip"],$shipment["d_zip"],$new_classes,$weights);
		...
		$usf_rates = autoRateUSF_37($shipment["o_zip"],$shipment["d_zip"],$classes,$weights);
...
// does a quote
function autoRateUSF_37($origin_zip,$destination_zip,$classes,$weights){
...
function checkStates_37($o_state,$d_state){
	$states = array("ND","SD","NE","KS","MN","WI","IA","IL","MO","MI","IN","OH","NY","PA","WV","KY","VA","TN","NC","SC","MS","AL","GA","FL");
